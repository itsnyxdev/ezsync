...
async def refresh_token(
    ...
    token_query = select(Token).where(Token.jwt_id == refresh_jti)
    ...
    try:
        ...
        new_access_token_record = Token(
            jwt_id=new_access_jti, user_id=token_record.user_id
        )
